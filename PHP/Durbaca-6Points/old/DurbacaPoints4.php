...
<head>
  ...
  //$arrayOfStudents = ["Parraga Melanie"=>"Parraga Melanie", "Carvalho Diogo"=>"Carvalho Diogo", "Shafiq Hassam"=>"Shafiq Hassam", "Oliveira Rui"=>"Oliveira Rui", "Mendes Milton"=>"Mendes Milton", "Markulin Filip"=>"Markulin Filip", "Miniatis Fanourios"=>"Miniatis Fanourios", "Dos Santos Rúben"=>"Dos Santos Rúben", "Murtadha Mustafa"=>"Murtadha Mustafa", "Nonkovic Filip"=>"Nonkovic Filip", "Kushniryna Vladyslav"=>"Kushniryna Vladyslav", "Gloden Jeff"=>"Gloden Jeff", "Cazar Dominick"=>"Cazar Dominick", "Linster Francesco"=>"Linster Francesco", "Li Shaopeng"=>"Li Shaopeng"];
